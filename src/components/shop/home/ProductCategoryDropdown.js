...
const CategoryList = () => {
  ...
  return (
    <div className={`${data.categoryListDropdown ? "" : "hidden"} my-4 category-icon-wrapper`}>
      <hr />
      <div className="py-1 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 responsive-width">
